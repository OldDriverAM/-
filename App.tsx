...
const DONATION_TIERS: DonationTier[] = [
  { amount: 20, label: "微薄之力", description: "一杯咖啡的关怀，让代码跑得更顺畅。", icon: "☕" },
  { amount: 50, label: "诚挚助力", description: "一份午餐的支持，点亮新电脑的屏幕。", icon: "🍕" },
  { amount: 100, label: "强力加持", description: "一块固态的梦想，加速创造的每一个瞬间。", icon: "🚀" },
  { amount: 200, label: "终极梦想", description: "一颗核心的跳动，成为萧叶最坚实的后盾。", icon: "💎" },
];
